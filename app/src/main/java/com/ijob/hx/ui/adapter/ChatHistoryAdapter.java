...
public class ChatHistoryAdapter extends ArrayAdapter<EMContact> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.hx_listitem_row_chat_history, parent, false);
		}
		...
		if (conversation.getMsgCount() != 0) {
			...
			holder.message.setText(HXSmileUtils.getSmiledText(getContext(), CommonUtils.getMessageDigest(lastMessage,
							(this.getContext()))),
