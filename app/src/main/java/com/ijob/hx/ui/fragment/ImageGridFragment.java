...
import com.ijob.android.BuildConfig;
import com.ijob.android.R;
import com.ijob.hx.db.domain.HXVideoEntity;
import com.ijob.hx.ui.activity.RecorderVideoActivity;
import com.ijob.hx.ui.widget.RecyclingImageView;
import com.ijob.hx.utils.video.ImageCache;
import com.ijob.hx.utils.video.ImageResizer;
import com.ijob.hx.utils.video.Utils;
...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mList = new ArrayList<HXVideoEntity>();
		getVideoFile();
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(R.layout.hx_view_image_grid_fragment,
				container, false);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if (position == 0) {
			...
			HXVideoEntity vEntty = mList.get(position - 1);
			// 限制大小不能超过10M
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			...
			if (convertView == null) {
				...
				convertView = LayoutInflater.from(mContext).inflate(R.layout.hx_griditem_choose, container, false);
			...
			if (position == 0) {
				...
				HXVideoEntity entty = mList.get(position - 1);
	...
	private void getVideoFile() {
		...
		if (cursor != null && cursor.moveToFirst()) {
			do {
				...
				HXVideoEntity entty = new HXVideoEntity();
				entty.ID = id;
				entty.title = title;
				entty.filePath = url;
